...
exports.sendEmailOTP = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: "MediShare - Email Verification OTP",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #2563eb;">MediShare Email Verification</h2>
...
exports.sendForgotPasswordEmail = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_USER,
      to: email,
      subject: "MediShare - Temporary Password",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #2563eb;">MediShare - Temporary Password</h2>
          <p>Hello ${user.name},</p>
